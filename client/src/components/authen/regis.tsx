...
export const RegisterPage = ({ onLogin }: { onLogin: () => void }) => {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setMessage({
        type: "success",
        text: "สมัครสมาชิกสำเร็จ! กำลังพาไปหน้าเข้าสู่ระบบ...",
      });
      ...
      <div className="bg-white w-full max-w-250 min-h-162.5 rounded-[10px] shadow-2xl overflow-hidden grid grid-cols-1 lg:grid-cols-2 animate-in fade-in zoom-in-95 duration-700">
        ...
        <div className="p-8 lg:p-16 flex flex-col justify-center bg-white">
          ...
          <div className="mt-8">
            ...
            <button className="h-10 w-full flex items-center justify-center  border border-slate-100 rounded-[10px] hover:bg-slate-50 transition-all font-bold text-[10px] uppercase tracking-widest text-slate-600 italic">
