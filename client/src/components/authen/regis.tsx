      ...
      <div className="bg-white w-full max-w-[1000px] min-h-[650px] rounded-[10px] shadow-2xl overflow-hidden grid grid-cols-1 lg:grid-cols-2 animate-in fade-in zoom-in-95 duration-700">
        ...
        <div className="p-8 lg:p-16 flex flex-col justify-center bg-white">
          ...
          <form onSubmit={handleAuth} className="space-y-4">
            { (
              <div className="space-y-1.5">
                <label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest ml-1">Strategy Owner</label>
          ...
          <div className="mt-auto pt-10 text-center">
            <button onClick={onLogin} className="text-[11px] font-bold text-slate-400 hover:text-black transition-all uppercase tracking-widest">
