  ...
  return (
    <div className="h-screen bg-black text-white font-sans flex flex-col overflow-hidden">
      ...
      <div className="flex-1 flex overflow-hidden p-4 md:p-6 gap-4 bg-[#0a0a0a]">
        ...
        {/* ========================================== */}
        <aside className="w-full md:w-80 lg:w-96 flex flex-col bg-white rounded-2xl shadow-xl overflow-hidden border border-slate-200 shrink-0">
        ...
        {/* ========================================== */}
        <main className="flex-1 bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden flex flex-col min-w-0">
          {!selectedPortId ? (
                            ...
                            <thead>
                              <tr className="text-slate-400 border-b border-slate-100">
                                ...
                                {[
                                  ...
                                  <th key={m} className="py-2 font-medium">
                                    {m}
                                  </th>
                                ))}
                              </tr>
                            ...
                            <tbody>
                              {Object.keys(heatmapByYear)
                                ...
                                .map((year) => (
                                  ...
                                  >
                                    <td className="py-3 text-left font-bold text-slate-600">
                                      {year}
                                    </td>
                                      ...
                                      (data, idx) => {
                                        ...
                                        return (
                                          <td key={idx} className="py-1 px-1">
                                            <div
                                              className={`h-10 flex items-center justify-center rounded text-[11px] font-bold ${isPos ? "text-emerald-900" : "text-rose-900"}`}
                                              style={{
